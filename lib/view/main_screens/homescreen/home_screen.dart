...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final expenseTrackerprovider = Provider.of<ExpensetrackerViewmodel>(
        context,
        listen: false,
      );
      final bankprovider = Provider.of<BankaccountsViewmodel>(
        context,
        listen: false,
      );

      await couponprovider.fetchCoupons(context);
      await expenseTrackerprovider.fetchExpenseTrackerNames(context);
      await bankprovider.getAllBankAccounts(context);

      if (couponprovider.isCouponsLoading ||
          expenseTrackerprovider.isExpenseTrackerNamesLoading ||
          bankprovider.isAllBankAccountsLoading)
        return;
    });
  }
      ...
      builder: (context, constraints) {
        ...
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: Scaffold(
            ...
            body: Consumer3<CouponsViewmodel, ExpensetrackerViewmodel, BankaccountsViewmodel>(
              builder: (context, couponvm, expenseTrackervm, bankvm, _) {
                return SafeArea(
                  top: false,
                  child: Skeletonizer(
                    enabled:
                        couponvm.isCouponsLoading ||
                        expenseTrackervm.isExpenseTrackerNamesLoading ||
                                ...
                                children: [
                                  ...
                                  Center(
                                    child: Image.asset(
                                      ...
                                      height: (screenHeight * 0.22).clamp(
                                        50,
                                        100,
                                      ),
                                      fit: BoxFit.contain,
                                                                        ...
                                                                        Expanded(
                                                                          child: Column(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                "Valid until: ${DateFormat('dd MMM yyyy').format(homecoupon.expiryDate)}",
                                                                                style: TextStyle(
                                                                                  fontSize: 14.sp,
                                                                                  fontWeight: FontWeight.bold,
